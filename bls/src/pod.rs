...
#[serde_as]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq, Deserialize, Serialize, Ord, PartialOrd)]
#[repr(transparent)]
...
#[serde_as]
#[derive(Clone, Copy, Debug, Hash, Eq, PartialEq, Deserialize, Serialize, Ord, PartialOrd)]
#[repr(transparent)]
pub struct Pubkey(
